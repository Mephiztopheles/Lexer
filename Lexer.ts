...
export default class Lexer {
    ...
    static readonly TERMINATOR: string = "TERMINATOR";
    ...
    protected string () {
        ...
        let firstChar = this.chunk.charAt( 0 ),
            quoted    = false,
            nextChar;
    ...
    protected tokenize ( source: string ) {
...
export class LexerEntry {
    ...
    constructor ( public key: string, public value: string | number, public index: number ) {
    }
}